...
import {onPhaseStart, onResultOpen, onRoomUserListUpdate, onStateUpdate} from "@/@types/WebsocketEvent";
...
const typeGuard = {
  ...
  joinRoomResponse: (i: unknown): i is joinRoomResponse =>
    typeof i === "object" && (i as joinRoomResponse).type === "joinRoomResponse",
  ...
  onRoomUserListUpdate: (i: unknown): i is onRoomUserListUpdate =>
    typeof i === "object" && (i as onRoomUserListUpdate).type === "onRoomUserListUpdate",
